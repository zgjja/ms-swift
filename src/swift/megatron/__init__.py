...
if TYPE_CHECKING:
    from .argument import MegatronRLHFArguments, MegatronTrainArguments
    from .model import MegatronModelMeta, MegatronModelType, get_megatron_model_meta, register_megatron_model
    from .train import megatron_pt_main, megatron_rlhf_main, megatron_sft_main
    from .trainers import MegatronDPOTrainer, MegatronTrainer
    from .utils import adapter_state_dict_context, convert_hf2mcore, convert_mcore2hf, prepare_mcore_model
else:
    _import_structure = {
