...
def _patch_training_log():
    ...
    from megatron.training import (get_args, get_one_logger, get_tensorboard_writer, get_timers, get_wandb_writer,
                                   is_last_rank, one_logger_utils, print_rank_last, training)
