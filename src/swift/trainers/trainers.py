...
class EmbeddingTrainer(Trainer):
    ...
    def calculate_metric(self, eval_prediction: EvalPrediction) -> Dict[str, float]:
        from swift.plugin.loss import calculate_infonce_metrics, calculate_paired_metrics, infonce_loss
...
class RerankerTrainer(Trainer):
    ...
    def __init__(self, *args, **kwargs):
        ...
        from swift.plugin.loss import LossType, get_loss_func
    ...
    def calculate_metric(self, eval_prediction: EvalPrediction) -> Dict[str, float]:
        from swift.plugin.loss import LossType, calculate_reranker_metrics, get_loss_func
